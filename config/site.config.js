...
module.exports = {
  ...
  protectedRoutes: ['/H_个人文件', '/B_班级通知/F_力学系班导师制度个人信息档案','/B_班级通知/X_先进班级','/B_班级通知/Z_2021-2022大二中期寒假/个人志愿活动认定'], 
  protectedRoutes: ['/A_学业文件/Z_已完成/Y_英语','/A_学业文件/Z_已完成/S_数学物理方程/杂文件','/A_学业文件/Z_已完成/ZZzz_题库'], 
  protectedRoutes: ['/A_学业文件/Z_已完成/L_流体力学/课堂演讲','/A_学业文件/Y_杂文件/陈年外刊/2022 Soren18期寒假课(完结)'], 
