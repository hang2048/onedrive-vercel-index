...
module.exports = {
  ...
  protectedRoutes: [
    ...
    '/A_学业文件/Z_已完成/Y_英语', '/A_学业文件/Z_已完成/S_数学物理方程/杂文件', '/A_学业文件/Z_已完成/ZZzz_题库', '/A_学业文件/Y_杂文件/陈年外刊/2022 Soren18期寒假课', 
    '/A_学业文件/Y_杂文件/电子书·在读/ZZzz_私藏小书库', '/A_学业文件/Z_已完成/F_Fortran远古历史遗留文件', '/A_学业文件/Z_已完成/L_理论力学/AAAA_理论力学课程报告', 
    '/A_学业文件/Z_已完成/M_马原', '/B_班级通知/H_换寝工作安排-工力', '/A_学业文件/Y_杂文件/雅思托福四六级/每日一篇经济学人（暂时开放更新中）', 
    '/A_学业文件/A_正在进行中/G-结构力学/结构力学（研）_合肥工业大学/其余资料（加密防商用，有需要请联系）', 
  ], 
